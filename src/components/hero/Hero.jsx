...
const Hero = () => {
  ...
  const [videoLoaded, setVideoLoaded] = useState(false);
  const [currentLang, setCurrentLang] = useState(i18n.language); // Re-render trigger

  useEffect(() => {
    const handleLanguageChange = (lng) => {
      setCurrentLang(lng); // Til o'zgarganda componentni qayta render qilish
    };
    ...
    <>
      <div className="hero">
        ...
        <div className="hero__bottom">
          <div className="hero__bottom__left container">
            <p className="hero__bottom__left-text">
              {t("Полный цикл производства современных высококачественных автозапчастей для легковых и грузовых автомобилей")}
            </p>
          </div>
