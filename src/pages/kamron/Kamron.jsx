...
import img from "../../assets/kamron/img.png"
import './kamron.scss'
    ...
    return (
        <div className="kamron">
            ...
            <div className="kamron__info">
                ...
                <h1 className="kamron__name">Erkinov Kamronbek</h1>
                <p className="kamron__role">Head of the commercial department</p>
            </div>
            ...
            <div className="kamron__actions">
                ...
                <a className="kamron__btn" href="https://wa.me/+998998094955" target="_blank" rel="noopener noreferrer">
                ...
                <a className="kamron__btn" href="k.erkinov@trt-parts.com">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="kamron__divider">
                    <span />
                    <svg viewBox="0 0 24 14" fill="none" stroke="currentColor" strokeWidth="2.5"
                        strokeLinecap="round" strokeLinejoin="round" width="18">
                        <polyline points="2,2 12,12 22,2" />
                    </svg>
                    <span />
                </div>

                <a className="kamron__btn" href="https://trt-parts.com/" target="_blank" rel="noopener noreferrer">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
