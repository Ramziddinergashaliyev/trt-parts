    ...
    <div className="company">
      <div className="container">
        ...
        <div className="company__info">
          ...
          <div className="company__info__left">
            ...
            <h3 className="company__info__left-desc reveal fade-up d2">
              TECHNOLOGIES OF REAL TIME
            </h3>

            <p className="company__info__left-texts reveal fade-up d3">
              <span>{t("trttext")}</span>
              <br />
              <span>{t("трудятся")}</span>
              <br />
        ...
        <div className="company__info__bottom">
          <p className="company__info__bottom-text reveal fade-up d1">{t("Лаборатория")}</p>
          <p className="company__info__bottom-text reveal fade-up d2">{t("Особое")}</p>
          <p className="company__info__bottom-text reveal fade-up d3">{t("При производстве")}</p>
        </div>
      ...
      <div className="company__swiper">
        <div className="container">
          ...
          <h4 className="company__swiper-title reveal fade-up">
            {t("Наши Сертификаты")}
          </h4>

          <div className="reveal fade-up d1">
            <Swiper
              modules={[Pagination, Navigation, Autoplay]}
              autoplay={{ delay: 2500, disableOnInteraction: false }}
              navigation
